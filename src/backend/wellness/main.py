...
from proto import WellnessServicer, add_WellnessServicer_to_server
...
async def start_grpc_server(wellness_controller: WellnessServicer) -> None:
    ...
    add_WellnessServicer_to_server(wellness_controller, server)
...
async def main() -> None:
    ...
    wellness_controller = service_factory.get_wellness_controller()
    grpc_task = asyncio.create_task(start_grpc_server(wellness_controller))
